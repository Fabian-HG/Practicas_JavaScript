...
function califica(sValor, oTbl, oCeldaCal) {
            ...
            for (i = 1; i <= 10; i++) {
                ...
                if (isNaN(sValorCapturado))
                    ...
                    if (nCapturado == (nTabla * i)) {
                        ...
                        sValorCapturado = document.getElementById("txtResultado" + i).style = "border: 4px solid #ff1e56; background-color: #ff1e56";
                    }
                }
            }
    ...
    if (sErr == "") {
        calificacion = document.createTextNode("Calif = " + nCalif);
        var label = document.createElement('label');
        var formulario = document.getElementById('formulario');
        formulario.appendChild(label);
        label.appendChild(calificacion);
        label.style = "font-family: 'Arial'; color: #333333; font-size: 2rem; display:block;";
    } else {
        error = document.createTextNode(sErr);
        var label2 = document.createElement('label');
        var formulario = document.getElementById('formulario');
        formulario.appendChild(label2);
        label2.appendChild(error);
        label2.style = "font-family: 'Arial'; color: #ff1e56; font-size: 2rem; display:block;";
    }
}